...
Scanner::Scanner(const string &source, Logger &logger)
    : logger_(logger), tokens_(), lineNo_(1), charNo_(0), ch_{}, eof_(false), input_(source)
{
    path_ = "main.Mod";
    init();
    read(); // Start reading the first character
}

Scanner::~Scanner()
{
    // No need to close anything, since we are using istringstream instead of ifstream
}

void Scanner::init()
{
    keywords_ = {{"DIV", TokenType::op_div}, {"MOD", TokenType::op_mod}, {"OR", TokenType::op_or}, {"IN", TokenType::op_in}, {"IS", TokenType::op_is}, {"MODULE", TokenType::kw_module}, {"IMPORT", TokenType::kw_import}, {"PROCEDURE", TokenType::kw_procedure}, {"EXTERN", TokenType::kw_extern}, {"BEGIN", TokenType::kw_begin}, {"END", TokenType::kw_end}, {"RETURN", TokenType::kw_return}, {"LOOP", TokenType::kw_loop}, {"EXIT", TokenType::kw_exit}, {"WHILE", TokenType::kw_while}, {"DO", TokenType::kw_do}, {"REPEAT", TokenType::kw_repeat}, {"UNTIL", TokenType::kw_until}, {"FOR", TokenType::kw_for}, {"TO", TokenType::kw_to}, {"BY", TokenType::kw_by}, {"IF", TokenType::kw_if}, {"THEN", TokenType::kw_then}, {"ELSE", TokenType::kw_else}, {"ELSIF", TokenType::kw_elsif}, {"CASE", TokenType::kw_case}, {"VAR", TokenType::kw_var}, {"CONST", TokenType::kw_const}, {"TYPE", TokenType::kw_type}, {"ARRAY", TokenType::kw_array}, {"RECORD", TokenType::kw_record}, {"OF", TokenType::kw_of}, {"POINTER", TokenType::kw_pointer}, {"NIL", TokenType::kw_nil}, {"TRUE", TokenType::boolean_literal}, {"FALSE", TokenType::boolean_literal}};
}
...
{
    input_.seekg(pos.offset - (streampos)1);
...
void Scanner::read()
{
    ...
    {
        logger_.error(path_, "error reading file.");
        exit(1);
    }
}
